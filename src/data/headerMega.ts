      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            href: "/services/realtime-systems",
            iconBase: S.backend,
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            href: "/services/payments-billing",
            iconBase: S.mvp,
          ...
          },
          {
            ...
            description: "Dynamic tour packages, WhatsApp bookings & cinematic UI.",
            href: "/projects/desert-speed-tourism",
            iconBase: S.fullstack,
            imageSrc: "https://iad.microlink.io/2bJgTlbtbC6Cwz3wjtDE1jALxzowQh-yFmsV88IiTwdZA_rxXR4PUQIACkdcrHbLtKfDsYWqFTskkkfV3sEgBg.png",
          },
        ],
      },
    ],
        ...
        links: [
          {
            ...
            iconBase: W.featured,
            imageSrc: "/images/projects/live/cliender.png",
            badge: "Live",
          },
          {
            id: "hrms",
            ...
            imageSrc: "/images/projects/live/hrms-portal.png",
            badge: "Beta",
          },
          {
            id: "tourism-safari",
            label: "Desert Speed Tourism",
            description: "WhatsApp booking, tour packages & premium cinematic design.",
            href: "/projects/desert-speed-tourism",
            iconBase: W.all,
            imageSrc: "https://iad.microlink.io/2bJgTlbtbC6Cwz3wjtDE1jALxzowQh-yFmsV88IiTwdZA_rxXR4PUQIACkdcrHbLtKfDsYWqFTskkkfV3sEgBg.png",
            badge: "Live",
        ...
        links: [
          {
            ...
            href: "/projects/mejora-tu-dolor",
            iconBase: W.liveDemo,
            imageSrc: "/images/projects/live/mejora-tu-dolor.png",
            badge: "Live",
          },
          {
            id: "padel",
            ...
            iconBase: W.featured,
            imageSrc: "/images/projects/live/padel-connect.png",
            badge: "Live",
          },
        ],
      },
        ...
        links: [
          {
            ...
            href: "/blog/category/featured-post",
            iconBase: I.featured,
        ...
        links: [
          {
            ...
            href: "/contact/inquiry-fullstack",
            iconBase: S.fullstack,
            imageSrc: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=200&h=200",
            badge: "Popular",
          },
...
export function getImageForSlug(slug: string): string | undefined {
  for (const panel of Object.values(HEADER_MEGA)) {
    // Check direct links
    for (const link of panel.links || []) {
      if (link.id === slug || link.href.includes(slug)) {
        return link.imageSrc?.replace("w=200&h=200", "w=1600&h=900");
      }
    }
    // Check section links
