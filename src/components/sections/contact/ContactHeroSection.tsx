...
export function ContactHeroSection({ category, imageSrc }: { category: ContactCategory; imageSrc: string }) {
  return (
    <section className="relative isolate min-h-[60vh] flex flex-col justify-end overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-24 bg-[#050505]">
      ...
      <div className="layout-wrap relative z-10 w-full">
        ...
        <div className="max-w-4xl relative">
          ...
          >
            <h1 className="text-[2.75rem] font-medium leading-[1.05] tracking-tight text-white sm:text-[3.75rem] md:text-[4.5rem]">
              {category.title}
            </h1>
          </motion.div>
