  ...
  return (
    ...
    >
      ...
      <div className="layout-wrap relative z-10">
        ...
        {/* Mobile: separate stacked cards — Desktop: combined panel */}
        <div className="space-y-3 sm:space-y-0">
          ...
          <motion.div
            ...
            style={{ opacity: 1 }}
            className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#111111] shadow-[0_16px_48px_rgba(0,0,0,0.32)] sm:rounded-[28px] sm:shadow-[0_24px_80px_rgba(0,0,0,0.38)] lg:rounded-[28px]"
          >
            ...
            <div className="relative z-10 grid gap-0 p-5 sm:gap-10 sm:p-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-end lg:gap-10 lg:p-10 xl:p-12">
              ...
              {/* Supporting stats — desktop only inside featured panel */}
              <div className="hidden overflow-hidden rounded-2xl border border-white/[0.1] bg-black/35 backdrop-blur-sm sm:grid sm:grid-cols-3 lg:grid-cols-1">
          ...
          {/* Mobile only: each supporting stat as its own card */}
          <div className="grid gap-3 sm:hidden">
            {supporting.map((stat, i) => (
              ...
              >
                ...
                {stat.detail ? (
                  <p className="mt-1 text-[12px] leading-snug text-[#FFF7ED]/5">
                    {stat.detail}
                  </p>
                ) : null}
              </motion.div>
